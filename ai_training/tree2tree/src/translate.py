"""
Author for Comments and Adjustions: Ting-Chen Chen
...
# Pascal-Java Dataset
parser.add_argument('--train_data', type=str, default='../../parser/data/source_pascal_target_java_train.json',
                    help='training data')
parser.add_argument('--val_data', type=str, default='../../parser/data/source_pascal_target_java_validation.json',
                    help='training data')
parser.add_argument('--test_data', type=str, default='../../parser/data/source_pascal_target_java_test.json',
                    help='test data')
...
parser.add_argument('--source_lang', type=str, default='pascal',
                    help='the source language of the translator')
parser.add_argument('--target_lang', type=str, default='java',
